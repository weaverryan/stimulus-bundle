...
namespace Symfony\StimulusBundle\Tests\Twig;
...
final class StimulusTwigExtensionTest extends TestCase
{
    ...
    public function testRenderStimulusController(string $controllerName, array $controllerValues, array $controllerClasses, string $expectedString, array $expectedArray): void
    {
        ...
        $dto = $extension->renderStimulusController($this->twig, $controllerName, $controllerValues, $controllerClasses);
    ...
    {
        $extension = new StimulusTwigExtension();
        $dto = $extension->renderStimulusController($this->twig, 'my-controller', ['myValue' => 'scalar-value']);
        $this->assertSame(
    ...
    {
        $extension = new StimulusTwigExtension();
        $dto = $extension->renderStimulusAction($this->twig, $controllerName, $actionName, $eventName, $parameters);
        $this->assertSame($expectedString, (string) $dto);
        $this->assertSame($expectedArray, $dto->toArray());
    }
    ...
    {
        $extension = new StimulusTwigExtension();
        $dto = $extension->renderStimulusAction($this->twig, 'my-controller', 'onClick', 'click');
        $this->assertSame(
    ...
    {
        $extension = new StimulusTwigExtension();
        $dto = $extension->renderStimulusTarget($this->twig, $controllerName, $targetName);
        $this->assertSame($expectedString, (string) $dto);
        $this->assertSame($expectedArray, $dto->toArray());
    }
    ...
    {
        $extension = new StimulusTwigExtension();
        $dto = $extension->renderStimulusTarget($this->twig, 'my-controller', 'myTarget');
        $this->assertSame(
